...
export default class Gallery extends Component {
  ...
  allImgsLoop = () => {
    return this.state.allimgs.map((item, i) => {
      return (
        <div onClick={this.clickedThumb.bind(null, i)} key={i} className="thumb-img">
          <img
            style={{
    ...
    return (
      <div>
        <div className="main-image">
          <div onClick={this.prevBtn} className="arrows left-arrow">
            {"<"}
          </div>
          <div onClick={this.nextBtn} className=" arrows right-arrow">
            {">"}
          </div>
          <div
            className="image-1"
